...
def fetch_chicago_crimes(days: int, limit: int, allow_insecure_ssl: bool) -> list[dict[str, Any]]:
...
def main() -> None:
    args = parse_args()
    rows = fetch_chicago_crimes(days=args.days, limit=args.limit, allow_insecure_ssl=args.allow_insecure_ssl)
